...
<div class="container mt-5">
    <h2>Admin Reply</h2>
    <?php
    $sql_messages = "SELECT messages.id, messages.message_text, messages.sender_id, members.name FROM messages
                    INNER JOIN members ON messages.sender_id = members.Memberid
    ...
    while ($row = $result_messages->fetch_assoc()) {
        ...
        echo "<h5 class='card-title'>Message from User " . $row['name'] . "</h5>";
