<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="add_levels.php">Membership Types</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="view_members.php">Members</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_class.php">Classes</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="view_attendance.php">Attendance</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_offers.php">Offers</a>
      </li>
      <li class="nav-item ">
